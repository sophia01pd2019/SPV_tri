...
A0 = [0.5, 0.9, 0.5]    # Pdgfra-, Pdgfra+, epithelium
...
P0 = [3.722, 3.812, 3.722] # * np.sqrt(vor.A0)

# Motility
v0 = [1.5, 7, 0.2]      # Pdgfra-, Pdgfra+, epithelium
...
EM = 0.09      # Epithelium-Mesenchyme (s12 in Cahn-Hilliard)
EG = 0.1      # Epithelium-Green (s13)
MG = 0.075      # Mesenchyme-Green (s23)
